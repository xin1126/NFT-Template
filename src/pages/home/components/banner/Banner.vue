  ...
  <div class="md:container">
    <div class="md:flex">
      <div class="hidden bg-black xl:block">
        ...
        >
          Recommend <span class="mt-5 text-[20px] tracking-widest">推 薦 系 列</span>
        </p>
      </div>
    ...
    <div class="xl:flex">
      ...
      <div class="flex flex-col-reverse md:flex-row-reverse xl:w-2/4  xl:flex-row">
        ...
        <img class="w-full border-black md:h-[360px] md:w-[50%] md:border-b-2 md:border-l-2 xl:border-l-0 xl:border-r-2" src="@/assets/images/art27.jpg" alt="art">
      </div>
    </div>
  </div>
</template>
